...
const Toast = ({ fn, toastClass }) => {
  return (
    <div
      ...
      className={`${toastClass} fixed left-1/2 top-2 z-50 w-72 -translate-x-1/2 transform space-y-4 rounded-md bg-green-600 p-5 text-white transition-all duration-1500  ease-in-out sm:w-96`}
    >
      <div>
