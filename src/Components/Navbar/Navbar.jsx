...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 z-40 w-full">
      <div className=" flex items-center justify-start bg-white px-5 py-3 shadow-md">
        <div className="rounded-sm bg-[#cb1313]  p-1 text-3xl font-bold text-white ">
          AL
        </div>
        <div className="text-3xl font-bold">maBetter</div>
      </div>
      <div className="bg-[#f5f2ed] px-5 pb-4 pt-10 md:px-20 lg:px-32">
        ...
        <div className="realtive z-0 mt-2 h-[2px] w-full bg-gray-500 opacity-50"></div>
      </div>
    </div>
  );
};
